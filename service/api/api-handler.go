...
func (rt *_router) Handler() http.Handler {
	...
	rt.router.GET("/users/:id/photos", rt.wrap(rt.getUserPhotos))
	rt.router.DELETE("/users/:id/photos/:photoid", rt.wrap(rt.DeleteUserPhoto))
	rt.router.GET("/users/:id/photos/:photoid", rt.wrap(rt.GetUserPhoto))
